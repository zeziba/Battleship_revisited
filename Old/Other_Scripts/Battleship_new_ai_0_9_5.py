...
class AI(Player):
    ...
    def adjust_for_hits(self):
        ...
        all_moves = [sublist_5 for sublist_5 in
                     [sublist_4 for sublist_4 in
                      [sublist_3 for sublist_3 in
                       [sublist_2 for sublist_2 in
                        [sublist for sublist in self.check_adj_tiles(self.hit_map) if sublist] if sublist_2] if sublist_3] if sublist_4] if sublist_5]
