...
class AI(Player):
    ...
    def adjust_for_hits(self):
        ...
        # moves = self.check_adj_tiles(self._hit_map)
        ...
        # most_adj_moves = [sublist for sublist in self.check_adj_tiles(even_more_adj_move) if sublist]
        all_moves = [
            sublist_5
            for sublist_5 in [
                sublist_4
                for sublist_4 in [
                    ...
                    for sublist_3 in [
                        ...
                        for sublist_2 in [
                            sublist
                            for sublist in self.check_adj_tiles(self.hit_map)
                            if sublist
                        ]
                        if sublist_2
                    ]
        ...
        # for cord_1, cord_2 in most_adj_moves:
        #     self.point_map[cord_1, cord_2] += 1
        for cord in all_moves:
            self.point_map[cord] += 2
